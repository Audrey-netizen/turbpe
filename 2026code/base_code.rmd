...
p_pcoa <- ggplot(pcoa_scores, aes(x = PCoA1, y = PCoA2, color = Treatment)) +
  ...
  base_theme + 
  theme(
    # Set the background to a hexcode, because apparently grey is different for
    # different figures what the helli
    panel.background = element_rect(fill = "#bbbbbbff", colour = NA),
    plot.background = element_rect(fill = "#bbbbbbff", colour = NA),
    
    # Legend styling to match background
...
#Export with "Squished" 2/3 Height (7x4.5 inches)
#ggsave("pcoa_plot_squished.png", 
#       plot = p_pcoa, 
#       width = 7, 
#       height = 4.5, 
#       units = "in", 
